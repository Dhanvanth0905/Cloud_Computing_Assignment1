...
class AddressBase(BaseModel):
    ...
    street: str = Field(
        ...
        json_schema_extra={"example": "736 Riverside Dr"},
    )
    city: str = Field(
        ...,
    ...
    postal_code: Optional[str] = Field(
        ...
        json_schema_extra={"example": "10031"},
    )
    country: str = Field(
        ...,
...
class AddressUpdate(BaseModel):
    ...
    street: Optional[str] = Field(
        None, description="Street address and number.", json_schema_extra={"example": "736 Riverside Dr"}
    )
    ...
    postal_code: Optional[str] = Field(
        None, description="Postal or ZIP code.", json_schema_extra={"example": "10031"}
    )
